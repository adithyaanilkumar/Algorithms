...
// Function to find the transpose of the given sparse matrix representation
// Parameters passed : sparse matrix, declared sparse matrix to create transpose
...
int main() {
  ...
  cout<<"\n The transpose of the given matrix in sparse matrix representation is : \n\n";
  displaySp(spAT);
  return 0;
}